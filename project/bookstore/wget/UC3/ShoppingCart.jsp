  ...
  <tr>
   ...
   <td valign="top">
    <table style="">
     ...
     <tr>
      <td style="background-color: #FFEAC5; border-style: inset; border-width: 0"><font style="font-size: 10pt; color: #000000">Login</font></td><td style="background-color: #FFFFFF; border-width: 1"><a href="MyInfo.jsp?"><font style="font-size: 10pt; color: #000000">guest</font></a></td>
     </tr>
     <tr>
      <td style="background-color: #FFEAC5; border-style: inset; border-width: 0"><font style="font-size: 10pt; color: #000000">First Name</font></td><td style="background-color: #FFFFFF; border-width: 1"><font style="font-size: 10pt; color: #000000">Guest&nbsp;</font></td>
     </tr>
     <tr>
     ...
     <tr>
      <td style="background-color: #FFEAC5; border-style: inset; border-width: 0"><font style="font-size: 10pt; color: #000000">Email</font></td><td style="background-color: #FFFFFF; border-width: 1"><font style="font-size: 10pt; color: #000000">guest@localhost&nbsp;</font></td>
     </tr>
     <tr>
     ...
     <tr>
      <td colspan="2" align="right"><input type="hidden" name="FormName" value="Member"><input type="hidden" value="" name="FormAction"><input type="hidden" name="member_id" value="2"><input type="hidden" name="PK_member_id" value="2"/></td>
     </tr>
     </form>
    </table>

  ...
  <tr>
   ...
   <td valign="top">
    <table style="" border=1>
     ...
     <tr><td style="background-color: #FFFFFF; border-width: 1"><font style="font-size: 10pt; color: #000000">guest&nbsp;&nbsp;</font><input type="hidden" name="FormAction" value="logout"/><input type="submit" value="Logout"/><input type="hidden" name="ret_page" value=""><input type="hidden" name="querystring" value=""></td>
     </form>
     </tr>
    </table>

  ...
  <tr>
   ...
   <td valign="top">
    <table style="" border=1>
     ...
     <tr>
      <td colspan="2" style="background-color: #FFFFFF; border-width: 1"><font style="font-size: 10pt; color: #000000">Login or Password is incorrect.</font></td>
     </tr>
     <form action="Login.jsp" method="POST">
     <input type="hidden" name="FormName" value="Login">
     <tr>
      <td style="background-color: #FFEAC5; border-style: inset; border-width: 0"><font style="font-size: 10pt; color: #000000">Login</font></td><td style="background-color: #FFFFFF; border-width: 1"><input type="text" name="Login" maxlength="50" value="admin"></td>
     </tr>
     <tr>
